...
class _SignupPageState extends State<SignupPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 1,
        iconTheme: const IconThemeData(color: Color(0xff0a1a3d)),
      ),
      body: Center(
                    ...
                    children: [
                      ...
                      GestureDetector(
                        ...
                        child: const Text(
                          "Sign In",
                          style: TextStyle(
                            color: Color.fromARGB(255, 73, 127, 243),
                            fontWeight: FontWeight.bold,
                          ),
                        ),
                      ),
  ...
  Widget _buildTextField({
    ...
    return TextFormField(
      ...
      textAlign: TextAlign.start, //  fixed: text starts from left
      decoration: InputDecoration(
        prefixIcon: Icon(icon),
        labelText: label,
        alignLabelWithHint: true, // label stays properly aligned
  ...
  Widget _buildPasswordField({
    ...
    return TextFormField(
      controller: controller,
      textAlign: TextAlign.start, //  text starts from left
      obscureText: obscure,
      decoration: InputDecoration(
